class BinarySearchTree:
    ...
    def find_successor(self):
        ...
        if self.has_right_child():
            successor = self.right_child.find_minimum()
        else:
            if self.parent:
                if self.is_left_child():
    ...
    def _put(self, key, data, current_node):
        if key < current_node.key:
            if current_node.has_left_child():
                ...
                current_node.left_child = Node(key, data, parent=current_node)
        else:
            if current_node.has_right_child():
                self._put(key, data, current_node.right_child)
            else:
                current_node.right_child = Node(key, data, parent=current_node)
...
class Node:
    def __init__(self, key, data, left_child=None, right_child=None, parent=None):
        self.key = key
        self.data = data
...
def main():
    ...
    binary_search_tree[0] = "popka"
    print(binary_search_tree[0])
    del binary_search_tree[0]
    print(binary_search_tree[0])
